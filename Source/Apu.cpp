...
////    APU_INSTANCE.writeRegister(startAddr_ + NRX3, (uint8_t)(period & 0xff));
...
////    APU_INSTANCE.writeRegister(startAddr_ + NRX4, (uint8_t)(period >> 8) | 0x80);
//}
//
//// NRX2, Osc 0,1,3 only
...
////                APU_INSTANCE.writeRegister(startAddr_ + NRX2, 0); // off
//                break;
...
////                    APU_INSTANCE.writeRegister(startAddr_ + NRX2, (velocity_ << 4) | (uint8_t) EnvelopeDirection::decreasing | release_);
//                }
//                break;
//        }
//    } else {
...
//                envelopeFramesRemaining_ = 0;
////                APU_INSTANCE.writeRegister(startAddr_ + NRX2, (velocity << 4)); // on
//                break;
...
////                    APU_INSTANCE.writeRegister(startAddr_ + NRX2, value);
//                }
//                break;
//        }
//    }
...
//    duty_ = duty;
////    APU_INSTANCE.writeRegister(startAddr_ + NRX1, (uint8_t) duty << 6);
//}
//
...
//{
//    setDuty(duty_);
////    APU_INSTANCE.writeRegister(startAddr_ + NRX0, 0x00); // disable sweep
//}
//
...
////    APU_INSTANCE.writeRegister(startAddr_ + NRX2, vol << 5);
//}
//
...
////        APU_INSTANCE.writeRegister(WaveTableAddr + i / 2, value);
//    }
//}
//
...
//{
////    APU_INSTANCE.writeRegister(startAddr_ + NRX0, 0x80); // enable the dac
//}
//
...
////    APU_INSTANCE.writeRegister(startAddr_ + NRX3, noiseRegisterValue);
////    
////    APU_INSTANCE.writeRegister(startAddr_ + NRX4, 0x80); // start sound
//}
//
...
//}
//
//void Apu::setEnabled(OSCID oscillator, bool enabled)
//{
...
//}
//
////void Apu::setTranspose(OSCID oscillator, int8_t transpose)
////{
////    jassert(oscillator < NUM_OSC);
...
////}
////
////void Apu::setMIDIVoice(OSCID oscillator, uint8_t voice)
////{
////    jassert(oscillator < NUM_OSC);
...
////}
////
////void Apu::setMIDIChannel(OSCID oscillator, uint8_t channel)
////{
////    jassert(oscillator < NUM_OSC);
...
////}
////
////void Apu::setAttackPeriod(OSCID oscillator, uint8_t period) {
////    jassert(oscillator < NUM_OSC);
////    oscs_[oscillator]->setAttack(period);
////}
////
////void Apu::setReleasePeriod(OSCID oscillator, uint8_t period) {
////    jassert(oscillator < NUM_OSC);
////    oscs_[oscillator]->setRelease(period);
////}
//
//void Apu::reconfigure(OSCID oscillator)
//{
...
////    APU_INSTANCE.writeRegister(NR50, 0x7F);
////    APU_INSTANCE.writeRegister(NR51, (enabled << 4) | enabled); // enable voices
//}
//
//void Apu::handleMIDI(juce::MidiBuffer& midiMessages)
//{
...
//}
//
//void Apu::handleMIDIEvent(juce::MidiMessage msg)
//{
