...
// generated with ruby:
// (0...32).map { |v| v % 16 }.map { |v| "0x0" + v.to_s(16) }.join(", ")
static const uint8_t WAVE_TABLE_RAMP_UP[WAVE_TABLE_SIZE] = {
...
// generated with ruby:
// (0...32).map { |v| (31-v) % 16 }.map { |v| "0x0" + v.to_s(16) }.join(", ")
static const uint8_t WAVE_TABLE_RAMP_DOWN[WAVE_TABLE_SIZE] = {
...
// generated with ruby:
// (0...32).map { |v| rand * 16 }.map(&:round).map { |v| "0x0" + v.to_s(16) }.join(", ")
static const uint8_t WAVE_TABLE_NOISE[WAVE_TABLE_SIZE] = {
    0x0b, 0x02, 0x0e, 0x03, 0x09, 0x02, 0x01, 0x02,
    0x07, 0x01, 0x0d, 0x07, 0x09, 0x0f, 0x010, 0x0a,
    0x010, 0x08, 0x00, 0x0c, 0x09, 0x04, 0x04, 0x0d,
    0x010, 0x09, 0x0a, 0x03, 0x01, 0x0f, 0x0f, 0x0f,
};
